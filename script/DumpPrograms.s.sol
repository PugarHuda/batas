...
contract DumpPrograms is Script {
    ...
    function run() external pure {
        _dump("basic", 101e18, 1.92143732923348277e18, 1788698356, 0.003e7, 1788698356);
        _dump("zero-fee", 1e18, 1e18, 1, 0, 0);
        _dump("max-cap", type(uint128).max, 0, 4294967295, 0.05e7, 18446744073709551615);
        _dump("tight-floor", 500e18, 2.5e18, 2000000000, 0.0001e7, 7);
    }
