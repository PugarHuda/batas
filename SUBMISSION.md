...
| "HTS tokens or custom fee schedules in the settlement path" | **met** — both. The paid route also accepts Batas Inspection Credit, HTS token `0.0.10523367`, settled by Blocky402; the token's fixed 0.01 BIC custom fee is assessed in the settlement itself, `0.0.7162784@1789303940.461488375` (`assessed_custom_fees` on the mirror node) |
